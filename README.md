...
search keyword	    - Пошук за частиною імені 
...
🧩 Покрокова робота команди birthdays-in

✅ Крок 1: Введення команди перевірки днів народження

Enter command: birthdays-in 5

Користувач вводить команду birthdays-in з аргументом 5, що означає:
🔍 Показати всі контакти, в яких день народження буде через 5 днів або раніше.

✅ Крок 2: Обробка команди
Програма отримує число 7 як аргумент.

Вона перевіряє:

У кожного збереженого контакту — чи є дата народження (birthday).
Якщо так — порівнює цю дату з поточним днем.
Обчислює, скільки днів залишилось до наступного дня народження.
Якщо день народження в межах 5 днів, контакт додається до результату.

✅ Крок 3: Вивід результату
🖨 Результат:

Upcoming birthdays in 5 days:

Contact name: Vita, birthday: 2024-07-25
Contact name: Oksana, birthday: 2024-07-27

📅 У цьому прикладі сьогодні, скажімо, 22 липня 2024, тому:

День народження Віти — через 3 дні.
День народження Оксани — через 5 днів.
Обидва контакти задовольняють умову <= 5 днів.
